...
- [GitHub Repository](https://github.com/fish-shell/fish-shell) ⭐ 30,089
...
- [Tide](https://github.com/IlanCosman/tide) ⭐ 3,435 - A modern prompt manager for Fish
- [Pure](https://github.com/pure-fish/pure/) ⭐ 1,324 - [_That_](https://github.com/sindresorhus/pure) ⭐ 13,620 ZSH prompt, now in Fish flavor
- [Hydro](https://github.com/jorgebucaran/hydro) ⭐ 791 - Lag-free prompt with async Git status (ooh la la)

## Plugins

- [z](https://github.com/jethrokuan/z) ⭐ 1,413 - Pure-Fish [`rupa/z`](https://github.com/rupa/z) ⭐ 16,664-like directory jumping
- [fzf](https://github.com/PatrickF1/fzf.fish) ⭐ 2,304 - Ef-🐟-ient key bindings for [`junegunn/fzf`](https://github.com/junegunn/fzf) ⭐ 70,893. ([Alternative](https://github.com/jethrokuan/fzf) ⭐ 887)
...
- [Replay](https://github.com/jorgebucaran/replay.fish) ⭐ 442 - Run Bash commands replaying changes in Fish. ([Alternative](https://github.com/edc/bass) ⭐ 2,311)
- [Spark](https://github.com/jorgebucaran/spark.fish) ⭐ 356 - Sparklines for Fish
- [Fisher](https://github.com/jorgebucaran/fisher) ⭐ 8,390 - Manage functions, completions, bindings, and snippets from the CLI
