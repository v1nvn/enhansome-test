...
- [GitHub Repository](https://github.com/fish-shell/fish-shell) ⭐ 30,163
...
- [Tide](https://github.com/IlanCosman/tide) ⭐ 3,451 - A modern prompt manager for Fish
- [Pure](https://github.com/pure-fish/pure/) ⭐ 1,328 - [_That_](https://github.com/sindresorhus/pure) ⭐ 13,635 ZSH prompt, now in Fish flavor
- [Hydro](https://github.com/jorgebucaran/hydro) ⭐ 796 - Lag-free prompt with async Git status (ooh la la)

## Plugins

- [z](https://github.com/jethrokuan/z) ⭐ 1,418 - Pure-Fish [`rupa/z`](https://github.com/rupa/z) ⭐ 16,673-like directory jumping
- [fzf](https://github.com/PatrickF1/fzf.fish) ⭐ 2,313 - Ef-🐟-ient key bindings for [`junegunn/fzf`](https://github.com/junegunn/fzf) ⭐ 71,184. ([Alternative](https://github.com/jethrokuan/fzf) ⭐ 888)
...
- [Fisher](https://github.com/jorgebucaran/fisher) ⭐ 8,408 - Manage functions, completions, bindings, and snippets from the CLI
